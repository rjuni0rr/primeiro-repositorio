<x-layouts.guest-layout subtitle="{{ empty($subtitle) ? '' : $subtitle }}">
    ...
    <div class="flex flex-col justify-center h-screen items-center">
        ...
        <div class="flex items-center mb-4">
            <img src="{{ asset('assets/images/ticket_display_logo.png') }}" class="w-20 h-20 me-2">
            <p class="text-5xl font-bold text-slate-600">Apresentador de filas</p>
        </div>

        <div class="main-card w-200">

            <form action="{{ route('queues.display.credentials.submit') }}" method="post" class="flex flex-col gap-4">
