    ...
    <div class="flex justify-center">
        <div class="main-card w-200 mt-12">
            <div class="text-center p-6">
                ...
                <p class="title-2 mb-4">Confirmar eliminação permanente do cliente</p>
                ...
                <div class="flex justify-center gap-4">
                    ...
                    <a href="{{ route('admin.perm.company.delete.confirm', ['id' => Crypt::encrypt($company->id)]) }}" class="btn-red"><i class="fa-solid fa-trash me-2"></i>Eliminar PERMANENTEMENTE</a>
                </div>
            </div>
        </div>
    </div>
